...
<sec:authorize access="hasRole('ADMIN')">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${contextPath}/registration">Register</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="${contextPath}/adminSalesData">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Catalog</span></a>
            </li>
                        <li class="nav-item">
                <a class="nav-link" href="${contextPath}/searchBySalesRepresentative">
                    <i class="fas fa-fw fa-folder"></i>
 ...
 <sec:authorize access="hasRole('ADMIN')">
            ...
            <form action="/createSRepresentative" method="post">
                    	<div class="row">
                            <div class="form-group col-md-8">
                                <label for="username" class="col-form-label">Username</label> 
                                <input type="text" name="username" class="form-control" 
                                            id="firstName" value="<c:out value="${srepresentative.username}"/>" required/>
                            </div>
                            <div class="form-group col-md-8">
                                <label for="password" class="col-form-label">Password</label> 
                                <input type="password" name="password" class="form-control" 
                                            id="lastName" value="<c:out value="${srepresentative.password}"/>" required/>
                            </div>
 <div class="form-group col-md-8">
